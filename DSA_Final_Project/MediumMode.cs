...
namespace DSA_Final_Project
{
    public partial class MediumMode : Form
    {
        ...
        private void InitializeComponents()
        {
            ...
            this.Text = "Medium Mode - Word Search";
        ...
        {
            int newRows = pictureGrid.GetLength(0) + 2; // Increase grid size by 2 rows
            int newCols = pictureGrid.GetLength(1) + 2; // Increase grid size by 2 columns

            MediumMode newGame = new MediumMode();
